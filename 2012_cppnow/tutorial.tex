...
\begin{frame}[fragile]
 ...
 \heading{Phase compacton lattice -- Transition to chaos}

 \vspace{2ex}

\centerline{\begin{sideways}\hspace{3ex}index\end{sideways} \includegraphics[draft=false,width=0.9\textwidth]{transition_chaos_1.jpg}}

\centerline{time}


\vspace{4ex}
\centerline{\begin{sideways}\hspace{3ex}index\end{sideways} \includegraphics[draft=false,width=0.9\textwidth]{transition_chaos_2.jpg}}
